    ...
    <>
      ...
      >
        ...
        <input 
          ...
          id="fieldEmail" 
          maxLength={200}
          name="cm-jdjlxu-jdjlxu" 
          placeholder="Your email" 
          required 
          type="email" 
          className="js-cm-email-input qa-input-email sc-gZMcBi dshyOS" 
        />
        <div className='country_signup'>
          ...
          <button className='button' onClick={() => {sessionStorage.setItem("emgNewsletterSeen", "true");}} type="submit">Sign up</button>
        </div>
      </form>
